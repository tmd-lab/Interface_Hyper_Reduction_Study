function [pgon_result,idx_result,triangle] = RemoveTriangle_v02(pgon,x,y,triangle_idx,varargin)
% varargin: Input of Results of first for second iteration 
% (Can be used to prefent usage of function "inpolygon" if 'Fake Results
% are used for initial step (can be removed afterwards))
...
%  figure
% hold on
% plot(x(triangle_idx(ii,:)),y(triangle_idx(ii,:)),'x')
% plot(pgon)
...
% Start next Iteration (MaxIter=25)
% if ~1==pgon_reduced.NumRegions
%     %Divide in Regions
% %
% %        figure
% %     plot(pgon_reduced)
%
%     RemoveTriangle(pgon_reduced,x,y,triangle_idx,Result)
%
%
%     % Auf übriggebliebene Elemente checken- abbruchkriterium
% end
%
