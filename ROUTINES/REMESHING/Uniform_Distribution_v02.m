function [NewElements_idx,sym_flag] = Uniform_Distribution_v02(Elements_idx,x,y,varargin)
...
if ~all(idx1==idx3(end:-1:1)) || ~all(idx2==idx4(end:-1:1))
    ...
    if ~sum(sort(idx3)-sort(idx1)) && ~sum(sort(idx4)-sort(idx2))
%         idx1 = sort(idx1);
%         idx4 = sort(idx4);
        idx3 = idx1(end:-1:1);
        idx4 = idx2(end:-1:1);
