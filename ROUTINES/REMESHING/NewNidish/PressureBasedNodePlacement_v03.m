function [New_Nodes,idx_OuterBound,idx_holeBound,dx] = PressureBasedNodePlacement_v03(x_red,y_red,x,y,preload_red,idx_reduced,bolt_idx,corners_idx,N_Segments,scaleFactor,Setting)
...
%   idx_reduced: Vector containing the indices of the reduced sizes with respect to the original vectors (x,y,preload)
%   [bolt_idx,corners_idx] index of nodes of corner / holde nodes obtainey by CreatBRBInterface Function
