function [Dtot,dx,dy,dn,Dx,Dy,Dn] = ZTEDISSIPATION(U,P,QuadMats,MESH)
...
%   D		: (Nnx1) Dissipation distribution estimate (inaccurate)
    ...
    Ux = QuadMats.Q*U(1:3:(3*MESH.Nn),:);
    Uy = QuadMats.Q*U(2:3:(3*MESH.Nn),:);
    Un = QuadMats.Q*U(3:3:(3*MESH.Nn),:);
