...
load(fname, 'M', 'K', 'L', 'R', 'Fv', 'Th', 'I2', 'LamT', 'cnum', 'MESH', 'PatchAreas', 'Npatches', 'dofred', 'GTG', 'Pels')
Prestress = 11580;
mi = 1;
...
Ktheta_lin = LamT(:, 4:6:6*Npatches)*diag(I2(1,:)*kn)*L(4:6:6*Npatches, :)*0 ...
    + LamT(:, 4:6:6*Npatches)*diag(I2(2,:)*kn)*L(5:6:6*Npatches, :)*0 ...
    + LamT(:, 5:6:6*Npatches)*diag(I2(2,:)*kn)*L(4:6:6*Npatches, :)*0 ...
    + LamT(:, 5:6:6*Npatches)*diag(I2(3,:)*kn)*L(5:6:6*Npatches, :)*0 ...
    + LamT(:, 6:6:6*Npatches)*diag(I2(4,:)*kt)*L(6:6:6*Npatches, :);
