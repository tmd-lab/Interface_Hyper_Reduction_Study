...
exx = load('../FULLJOINT_REF/DATS/RUN2.mat', 'QS', 'WS', 'ZS', 'DS', 'ZSM', 'DSM');
...
save(sprintf('./DATS/P%d_S%.2f_%dLEV_BB_JENK.mat',Prestress,log10(sint),Nlev), 'BB');
